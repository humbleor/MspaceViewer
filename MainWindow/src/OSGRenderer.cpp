#include "../include/OSGRenderer.h"


#include "../include/osgQOpenGLWidget.h"
...
void OSGRenderer::setupOSG(int windowWidth, int windowHeight, float windowScale)
{
    ...
    int w = static_cast<int>(windowWidth * windowScale);
    int h = static_cast<int>(windowHeight * windowScale);

    m_osgWinEmb = new osgViewer::GraphicsWindowEmbedded(0, 0, w, h);
